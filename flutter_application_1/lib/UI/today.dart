...
class _ScreenTodayState extends State<ScreenToday> {
  List<itemBox> truongtrinhdaotao = [
    itemBox(
        ...
        urlImg: 'assets/images/gamecaro.png'),
  ];
              ...
              SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    truongtrinhdaotao.isNotEmpty
                        ? newboxToday('Chương trình đào tạo', truongtrinhdaotao)
                        : Container(),
                    trochoithugian.isNotEmpty
                        ? newboxToday('Trò chơi thư giãn', trochoithugian)
                        : Container(),
                    baitest.isNotEmpty
                        ? newboxToday('Bài test được khuyên', baitest)
                        : Container(),
  ...
  Padding newitemBox(String nameGame, String desGame, String urlImg) {
    return Padding(
      padding: const EdgeInsets.only(
          left: 25, bottom: 20), // Thay margin bằng padding
      child: InkWell(
          onTap: () {
            Navigator.push(
              context,
          ...
          child: Container(
            ...
            child: Row(
                ...
                children: [
                  ...
                  ClipRRect(
                    borderRadius:
                        BorderRadius.circular(8), // Bán kính bo góc ảnh
                    child: Image.asset(
